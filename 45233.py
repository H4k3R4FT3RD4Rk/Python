...
paramiko.auth_handler.AuthHandler._handler_table[paramiko.common.MSG_SERVICE_ACCEPT] = \
    malform_packet
paramiko.auth_handler.AuthHandler._handler_table[paramiko.common.MSG_USERAUTH_FAILURE] = \
    call_error
...
arg_parser.add_argument('--outputFormat', choices=['list', 'json', 'csv'
...
if args.username:  # single username passed in
    ...
    if args.outputFormat == 'list':
        ...
        print '[+] Results successfully written to ' + args.outputFile \
            + ' in List form.'
